function model = compute_color_model_all(rootpath, outfile)
%% COMPUTE_COLOR_MODEL_ALL function generates a model for the adaptive skin
...
%
% Input:
%   - datapath: root directory with the datasets to process (each one containing
%   two subdirs for annotated and raw images). Skin annotations are indicated in 
